...
public class CalcolaSpeseOrdinarie implements Task {
	...
	public CalcolaSpeseOrdinarie(Condominio ilCondominio, int anno) {
	...
	public synchronized void esegui(Executor e) {
		...
		for (TipoLinkSostiene link : linkSostiene) {
			spesa = link.getSpesa();
			if (spesa.getAnno() == anno && spesa.getClass().equals(SpesaOrdinaria.class) ) {

...
public class AttivitaPrincipale implements Runnable {
	...
	public synchronized void run() {
		...
		CreaNuovaGara cng = new CreaNuovaGara();
		Executor.perform(cng);
		gara = cng.getRisultato();

		percorso = AttivitaIO.inserisciDatiPercorso();

		RegistraPercorso rp = new RegistraPercorso(gara, percorso);
		Executor.perform(rp);
